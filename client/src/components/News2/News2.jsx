...
{/* <article className="news">      
        ...
        <div>
          ...
          <NavLink to={newsother.link1} title="посмотреть статью" className="a_news">{newsother.titlelink1}</NavLink>
          <br />

          <NavLink to={newsother.link3} title="посмотреть статью" className="a_news">{newsother.titlelink3}</NavLink>
